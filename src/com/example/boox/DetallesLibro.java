...
public class DetallesLibro extends Fragment {
     ...
     */
    public static DetallesLibro newInstance(int index) {
    	Log.d("DetallesLibro", "newInstance("+index+")");
    	DetallesLibro f = new DetallesLibro();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
    	Log.d("DetallesLibro", "onCreateView");
        if (container == null) {
